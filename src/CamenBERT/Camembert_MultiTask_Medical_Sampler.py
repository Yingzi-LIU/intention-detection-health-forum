...
# ====================================================================
# 5. 主程序 (应用 Camembert 并对 Objet Médical 采样)
# ====================================================================
...
if __name__ == '__main__':
    ...
    print("\n--- 实验模式: Camembert + WeightedRandomSampler (Objet Médical) ---")
