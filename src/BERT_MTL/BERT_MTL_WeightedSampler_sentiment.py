...
if __name__ == '__main__':
    ...
    sampler = WeightedRandomSampler(
        ...
        replacement=True # Allow replacement sampling
    )
    ...
    fonction_pertes = {
        ...
        'sentiment': nn.CrossEntropyLoss() # Revert to standard cross-entropy loss
    }

    print("\n--- Experiment Mode: WeightedRandomSampler + Sum of Losses ---")
    ...
    for epoque in range(EPOQUES):
        ...
        print(f"Validation Metrics: Acc_Intention={validation_metrics['acc_intention']:.4f} F1={validation_metrics['f1_intention']:.4f} | "
              f"Acc_Medical_Object={validation_metrics['acc_objet_medical']:.4f} F1={validation_metrics['f1_objet_medical']:.4f} | "
    ...
    print(f"Test Metrics: Acc_Intention={test_metrics['acc_intention']:.4f} F1={test_metrics['f1_intention']:.4f} | "
          f"Acc_Medical_Object={test_metrics['acc_objet_medical']:.4f} F1={test_metrics['f1_objet_medical']:.4f} | "
          f"Acc_Sentiment={test_metrics['acc_sentiment']:.4f} F1={test_metrics['f1_sentiment']:.4f}")

    chemin_sauvegarde_modele = 'BERT_MedicalMultiTache_sampler.pth'
