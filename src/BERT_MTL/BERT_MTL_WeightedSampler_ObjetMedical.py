...
# ====================================================================
# 5. Main Program (modified - applied to Medical Object)
# ====================================================================
...
if __name__ == '__main__':
    ...
    # --- Use WeightedRandomSampler for the Medical Object task ---
    ...
    sampler = WeightedRandomSampler(
        weights,
        num_samples=num_samples, # the total number of samples per epoch remains constant
    ...
    print("\n--- Experiment Mode: WeightedRandomSampler (Medical Object) + Sum of Losses ---")
    ...
    for epoque in range(EPOQUES):
        ...
        training_loss = entrainer(modele, chargeur_donnees_train, optimiseur, scheduler, fonction_pertes, appareil)
        print(f"Training Loss: {training_loss:.4f}")
        validation_metrics = evaluer(modele, chargeur_donnees_valid, appareil)
        print(f"Validation Metrics: Acc_Intention={validation_metrics['acc_intention']:.4f} F1={validation_metrics['f1_intention']:.4f} | "
              f"Acc_Objet_Medical={validation_metrics['acc_objet_medical']:.4f} F1={validation_metrics['f1_objet_medical']:.4f} | "
              f"Acc_Sentiment={validation_metrics['acc_sentiment']:.4f} F1={validation_metrics['f1_sentiment']:.4f}")
    
    print("\n--- Evaluating on Final Test Set ---")
    test_metrics = evaluer(modele, chargeur_donnees_test, appareil)
    print(f"Test Metrics: Acc_Intention={test_metrics['acc_intention']:.4f} F1={test_metrics['f1_intention']:.4f} | "
          f"Acc_Objet_Medical={test_metrics['acc_objet_medical']:.4f} F1={test_metrics['f1_objet_medical']:.4f} | "
          f"Acc_Sentiment={test_metrics['acc_sentiment']:.4f} F1={test_metrics['f1_sentiment']:.4f}")

    model_save_path = 'BERT_MedicalMultiTache_sampler_objet_medical.pth'
    torch.save(modele.state_dict(), model_save_path)
