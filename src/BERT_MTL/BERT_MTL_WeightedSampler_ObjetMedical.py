...
if __name__ == '__main__':
    ...
    # --- 关键改动：使用 WeightedRandomSampler 应用于 Objet Médical 任务 ---
    ...
    print("\n--- 实验模式: WeightedRandomSampler (Objet Médical) + 损失加和 ---")
    ...
    chemin_sauvegarde_modele = 'BERT_MedicalMultiTache_sampler_objet_medical.pth'
